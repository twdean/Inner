...
@class AppDelegate;
@class Inner_iOS_Classes_UserNotificationCenterDelegate;
...
@class SegmentedControl_FormsPlugin_iOS_SegmentedControlRenderer;
...
@interface Inner_iOS_Classes_UserNotificationCenterDelegate : NSObject<UNUserNotificationCenterDelegate> {
}
	-(void) release;
	-(id) retain;
	-(int) xamarinGetGCHandle;
...
@interface SegmentedControl_FormsPlugin_iOS_SegmentedControlRenderer : Xamarin_Forms_Platform_iOS_ViewRenderer_2 {
}
	-(id) init;
@end
